          ...
          <div className={styles.heroImage}>
            ...
            <div className={styles.heroCalendarWrap}>
              <Image
                ...
                width={849}
                height={732}
                className={`${styles.heroCalendarImg} ${styles.imgDark}`}
                priority
              />
              <Image
                src="/images/hero-calendar-light.png"
                alt="Calendar preview"
                width={849}
                height={732}
                className={`${styles.heroCalendarImg} ${styles.imgLight}`}
                priority
              />
            </div>
          </div>
          <img src="/images/hero-glow.png" alt="" className={styles.heroGlow} />
        </div>
      </section>
        ...
        <div className={styles.cards} ref={cardsRef}>
          <div className={`${styles.card} ${styles.cardRed}`}>
            ...
            <div className={`${styles.cardImageWrap} ${styles.cardImageWrapRed}`}>
              <Image src="/images/card-course.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.cardImageShadowRed} ${styles.imgDark}`} />
              <Image src="/images/card-course-light.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.cardImageShadowRed} ${styles.imgLight}`} />
            </div>
          </div>
          <div className={`${styles.card} ${styles.cardBlue}`}>
            ...
            <div className={styles.cardImageWrap}>
              <Image src="/images/card-link.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.imgDark}`} />
              <Image src="/images/card-link-light.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.imgLight}`} />
            </div>
          </div>
          <div className={`${styles.card} ${styles.cardPurple}`}>
            ...
            <div className={`${styles.cardImageWrap} ${styles.cardImageWrapPurple}`}>
              <Image src="/images/card-sync.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.cardImageShadowPurple} ${styles.imgDark}`} />
              <Image src="/images/card-sync-light.png" alt="" width={580} height={749} className={`${styles.cardImage} ${styles.cardImageShadowPurple} ${styles.imgLight}`} />
            </div>
          </div>
        </div>
